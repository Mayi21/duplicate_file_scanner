          ...
          Wrap(
            ...
            children: [
              ...
              _buildActionChip(
                ...
                label: l10n.keepLargest,
                onTap: isEnabled ? () => onAction(BatchAction.keepLargest) : null,
                color: Colors.orange,
              ),
              _buildActionChip(
                context,
                icon: Icons.trending_down,
                label: l10n.keepSmallest,
                onTap: isEnabled ? () => onAction(BatchAction.keepSmallest) : null,
                color: Colors.orange,
              ),
            ],
          ),
